...
// import geoJSONData from "./parkings/ParkingTic2021.json";
...
const Home: NextPage = () => {
  ...
  useEffect(() => {
    ...
    var mapparams: any = {
      ...
      style: "mapbox://styles/kennethmejia/clh163tg9007401r5ak4sfn4x", // style URL (THIS IS STREET VIEW)
      ...
      >
        ...
        <div className="flex-initial h-content flex-col flex z-50">
          <div className="   max-h-screen flex-col flex z-5">
            ...
            >
              <strong className="">Parking Tickets 2021</strong>
            </div>
